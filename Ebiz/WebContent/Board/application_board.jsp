								...
								<div class="board_form" style="margin-bottom:100px;">
									<table class="board">
										<tr>
											...
											<td class="category" style="font-weight:bold"><%=category %></td>
										</tr>
										<tr>
											<td class="menu">제목</td>
										...
										<tr>
											<td class="menu">시간</td>
											<td class="work_time"><%=work_time %></td>
										</tr>	
										<tr>
											<td class="menu">지역</td>
										...
										<tr>
											<td class="menu">금액</td>
											<td class="credit" style="font-weight:bold;"><%=credit %></td>
										</tr>
										<tr>
											<td class="menu">상태</td>
											<td class="state"><%=state %><input type="button" class="info" value="자세히 보기" onclick="openApplication(<%=i%>)"></td>
										</tr>
									</table>
								</div>
								<%} %>
								 ...
								 <div class="board-bottom">
										...
										<p class="board" align="center" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="../Board/application_board.jsp?page=1&page_bundle=0" class="pagination">&lt;&lt;-</a> &nbsp;
											<a href="../Board/application_board.jsp?page=<%=prev_page%>&page_bundle=<%=prev_page_bundle%>" class="pagination">&lt;-</a> &nbsp; 
											<%for(int i = (current_page_bundle * 10) + 1; i <= (current_page_bundle * 10) + 10; i++){
												if(page_count < i){
													break;
												}
											%>
											<a href="../Board/application_board.jsp?page=<%=i %>&page_bundle=<%=current_page_bundle%>" class="pagination"><%=i %></a>&nbsp;
											<%} %> 
											<a href="../Board/application_board.jsp?page=<%=next_page %>&page_bundle=<%= next_page_bundle%>" class="pagination">-&gt;</a> &nbsp;
											<a href="../Board/application_board.jsp?page=<%=page_count%>&page_bundle=<%=page_bundle%>" class="pagination">-&gt;&gt;</a>
										 </p>
