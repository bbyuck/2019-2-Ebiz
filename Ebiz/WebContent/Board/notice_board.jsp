							...
							<section>
								...
								<!-- 글쓰기 버튼 및 검색 -->
								 <div class="board-bottom">
										...
										<a href="../Board/notice_board.jsp?page=1&page_bundle=0">&lt;&lt;-</a> &nbsp; <a href="../Board/notice_board.jsp?page=<%=prev_page%>&page_bundle=<%=prev_page_bundle%>">&lt;-</a> &nbsp; 
										<%for(int i = (current_page_bundle * 10) + 1; i <= (current_page_bundle * 10) + 10; i++){
											if(page_count < i){
												break;
											}
										%>
										<a href="../Board/notice_board.jsp?page=<%=i %>&page_bundle=<%=current_page_bundle%>"><%=i %></a>&nbsp;
										<%} %> 
										 <a href="../Board/notice_board.jsp?page=<%=next_page %>&page_bundle=<%= next_page_bundle%>">-&gt;</a> &nbsp; <a href="../Board/notice_board.jsp?page=<%=page_count%>&page_bundle=<%=page_bundle%>">-&gt;&gt;</a></p>
