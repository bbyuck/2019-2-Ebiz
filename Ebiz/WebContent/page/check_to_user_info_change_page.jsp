	 ...
	 %>
	 	...
	 	if(<%=id%> == null){
			...
			function pwChk(){
				if("<%=confirm%>" == "fail"){
					alert("비밀번호가 틀렸습니다.");
					document.pwChkForm.inputPassword.focus();
				}
			}
		</script>
	</head>
	<body class="is-preload" oncontextmenu="return false" ondragstart="return false" onselectstart="return false" onload="pwChk()">
		<!-- Wrapper -->
		<div id="wrapper">
			<!-- Main -->
			<div id="main">
				<div class="inner">
					...
					<section>
						<img src="../images/onemorepw.png" width="100%" style="margin-bottom:100px">
						<form action="../do/check_to_user_info_change.jsp" name = "pwChkForm" method="post" style="width: 100%; margin: 0 auto; margin-bottom:50px; ">
							<p style="display:inline">
								<input type="password" name="inputPassword" id="inputPassword" style="width:100%;" placeholder="비밀번호를 입력해주세요">
							</p>
							<br>
							<p align="center">
								<input type="submit" value="확인" style="margin-bottom:50px;">
							</p>
						</form>
